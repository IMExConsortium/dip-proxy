...
java -cp target/dip-proxy-client-jar-with-dependencies.jar edu.ucla.mbi.client.ProxyCommandClient http://dip.mbi.ucla.edu/dip-proxy/ws/soap/proxy-service $3 $4 $5 $6 $7 $8 $9 
fi
